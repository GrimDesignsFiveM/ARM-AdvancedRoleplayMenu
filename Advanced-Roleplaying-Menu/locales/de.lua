i18n.importData("de", {
	...
	info_fine_request_before_amount = "Dr�cke ~g~Y~s~ um das Strafgeld zu akzeptieren $",
	info_fine_request_after_amount = " , dr�cke ~r~R~s~ um es zu verweigern !",
	...
	help_text_open_cloackroom = "Dr�cke ~INPUT_CONTEXT~ um die ~b~Polizei Garderobe zu �ffnen",
	help_text_put_car_into_garage = "Dr�cke ~INPUT_CONTEXT~ um das Polizei Auto in die ~b~Garage zu parken",
	help_text_get_car_out_garage = "Dr�cke ~INPUT_CONTEXT~ um das Polizei Auto aus der ~b~Garage zu nehmen",
	help_text_put_heli_into_garage = "Dr�cke ~INPUT_CONTEXT~ um den Hubschrauber in die ~b~Garage zu parken",
	help_text_get_heli_out_garage = "Dr�cke ~INPUT_CONTEXT~ um den Hubschrauber aus der ~b~Garage zu nehmen",
	no_player_near_ped = "Kein Spieler in der N�he",
	no_veh_near_ped = "Kein Fahrzeug in der N�he",
	...
	menu_force_player_get_in_car_title = "Ins Fahrzeug bef�rdern",
	...
	menu_citizens_title = "B�rger",
	menu_vehicles_title = "Fahrzeuge",
	menu_close_menu_title = "Schlie�e das Menu",
	...
	menu_put_in_jail_title = "Ins Gef�ngis bringen",
	...
	jail_arrest_notification_part_1 = "Du wurdest verhaftet f�r ^1", -- send to the client after he got puted into the jail
	jail_arrest_notification_part_2 = " ^0Sekunden!",
	jail_weapons_removed = "Deine Waffen wurden entfernt weil du verhaftet wurdest!",
	jail_not_cuffed = "Der Spieler muss an Handschellen gef�sselt sein!",
	...
	cloackroom_add_bulletproof_vest_title = "Schu�sichere Weste anlegen",
	cloackroom_remove_bulletproof_vest_title = "Schu�sichere Weste entfernen",
	...
	help_open_menu_notification = "Dr�cke ~g~F5~w~ um das ~b~Polizei Menu ~w~zu �ffnen",
	...
	vehicle_checking_plate_part_2 = " geh�rt ", -- between number plate and player name when veh registered
	...
	force_player_get_in_vehicle_part_2 = " in das Fahrzeug zu bef�rdern",
	usage_command_setdept = "Benutze : /setdept [ID]",
	usage_command_coprem = "Benutze : /coprem [ID]",
	usage_command_coprank = "Benutze : /coprank [ID] [RANK]",
	command_received = "Roger that !",
	become_cop_success = "Herzlichen Gl�ckwunsch, Sie sind nun ein Polizist !~w~",
	remove_from_cops = "Sie sind kein Polizist mehr !~w~.",
	no_player_with_this_id = "Kein Spieler mit folgender ID gefunden !",
	not_enough_permission = "Du hast nicht die ben�tigten Rechte um diesen Befehl auszuf�hren !",
	...
	help_text_open_armory = "Dr�cke ~INPUT_CONTEXT~ um die Polizei Waffenkammer zu �ffnen",
	armory_add_bulletproof_vest_title = "Schu�sichere Weste anlegen",
	armory_remove_bulletproof_vest_title = "Schu�sichere Weste entfernen",
	armory_weapons_list = "Waffen ausw�hlen",
